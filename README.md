...
###[View Live tyler Blog &rarr;](https://huangxuan.me)
...
```
$ git clone git@github.com:tylerpro/tylerblog-boilerplate.git
```

**[View Boilerplate Here &rarr;](http://huangxuan.me/tylerblog-boilerplate/)**


## Porting 

- [**Hexo**](https://github.com/Kaijun/hexo-theme-tylerblog) by @kaijun
- [**React-SSR**](https://github.com/LucasIcarus/tylerpro.github.io/tree/ssr) by @LucasIcarus

## Translation

 - ![cn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **Chinese (Simplified)**: 感谢 [@BrucZhaoR](https://github.com/BruceZhaoR) 的 [中文翻译 &rarr;](https://github.com/tylerpro/tylerpro.github.io/blob/master/README.zh.md)
...
- Fixed [issue#15](https://github.com/tylerpro/tylerpro.github.io/issues/15) about code wrap.
...
```
# Site settings
title: tyler Blog             # title of your website
SEOTitle: tyler Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: tylerpro     # modify this account to yours
weibo_username: tylerpro      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-tyler.jpg     # use absolute URL.
```
...
Change header images of any pages or any posts is pretty easy as mentioned above. But, thanks to [issue #6 (in Chinese)](https://github.com/tylerpro/tylerpro.github.io/issues/6) asked, **how to make it looks great?**
...
It's possible that you want the two things different. For me, my site-title is **“tyler Blog”** but I want the title shows in search engine is **“黄玄的博客 | tyler Blog”** which is multi-language.
...
Apache License 2.0.
Copyright (c) 2015-2016 tylerpro

tyler Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
